// تاریخ دوشنبه - 18 خرداد 1405 - حاجی یادگاری میشه اینم لعنتی امیدوارم به ارزوت برسی
...
async function 请求日志记录(env, request, clientIP, 请求类型 = "Get_SUB", config_JSON, 是否写入KV日志 = true) {
    // تابع لاگ‌گیری به طور کامل غیرفعال شد تا پینگ کاهش یابد
    return;
}

// اگه خواستی فعال کنی پایین رو از کامنت در بیار بالایی رو کامنت کن
...
async function DoH查询(域名, 记录类型, DoH解析服务 = "https://1.1.1.1/dns-query") {
...
// اینجارم برا پینگ قطع میکنیم چوم الکی درخواست نده
			}
		}
	} catch (error) {
